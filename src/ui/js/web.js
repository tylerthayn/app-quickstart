...
(function () {
	...
	let options = {
		prefix: '../../node_modules',
		require: {
			deps: ['jquery', 'lodash', 'jquery-ui', '@tyler.thayn/js.core', 'jQuery', 'Observers', 'Ui', 'notifyjs', 'js/main'],
			paths: {
				...
				'@tyler.thayn/maps.core': '{{prefix}}/@tyler.thayn/maps.core/dist/maps',
				'jQuery': '{{prefix}}/@tyler.thayn/jquery/jQuery',
				...
				Observers: '{{prefix}}/@tyler.thayn/observers/Observers',
				requirejs: '{{prefix}}/requirejs/require.js',
				Ui: '{{prefix}}/@tyler.thayn/ui/Ui',
				App: 'js/App'
			},
			map: {
				'*': {
					'@js/core': '@tyler.thayn/js.core'
				}
			}
		}
	}
